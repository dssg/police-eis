...
CREATE  TABLE staging.incidents (
  ...
  incident_type_level1                       TEXT, -- raw type of incident
  incident_type_level2                       TEXT, -- group raw type of incident
  incident_type_level3                       TEXT, -- group level2 type of incident
